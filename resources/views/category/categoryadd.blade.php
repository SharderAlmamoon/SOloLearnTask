      ...
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{route('category.all')}}">Manage Category</a>
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <span class="ml-2 d-none d-lg-inline text-white small">{{Auth::user() ? Auth::user()->name :'Solo Lern' }}</span>
              </a>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Category Add Page</h1>
            <ol class="breadcrumb">
                    ...
                    <form action="{{route('category.store')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                         ...
                         @enderror
                          ...
                          <div class="form-group">
                            <label for="">Related Category</label>
                             <select name="category_related" id="" class="form-control">
